...
file_prefix = "../../"
files = {2007:'2007_day.csv',2008:'2008_day.csv',2009:'2009_day.csv',2010:'2010_day.csv',2011:'2011_day.csv',2012:'2012_day.csv',2013:'2013_day.csv',2014:'2014_day.csv',2015:'2015_day.csv',2016:'2016_day.csv',2017:'2017_day.csv'}
...
day_table = "CREATE TABLE IF NOT EXISTS day (cdate datetime NOT NULL, tradingsymbol_no int(7) NOT NULL,open decimal(7,2) NOT NULL,high decimal(7,2) NOT NULL,low decimal(7,2) NOT NULL,close decimal(7,2) NOT NULL,volume int(12) NOT NULL,PRIMARY KEY (cdate,tradingsymbol_no), KEY cdate (cdate), KEY tradingsymbol_no (tradingsymbol_no), CONSTRAINT tradingsymbol_no_ibfk1 FOREIGN KEY (tradingsymbol_no) REFERENCES tradingsymbols (tradingsymbol_no) ON DELETE CASCADE )"
cursor.execute(day_table)
...
for y in years:
    ...
    for index in range(0,len(cdate_list)):
        ...
        add_candle = "INSERT INTO day (cdate, tradingsymbol_no, open, high, low, close, volume)  VALUES (%(cdate)s, %(tradingsymbol_no)s, %(open)s, %(high)s, %(low)s, %(close)s, %(volume)s)"
